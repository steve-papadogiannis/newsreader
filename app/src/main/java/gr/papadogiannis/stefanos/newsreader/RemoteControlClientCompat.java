...
class RemoteControlClientCompat {
    ...
    static Class getActualRemoteControlClientClass(ClassLoader classLoader)
    ...
    RemoteControlClientCompat(PendingIntent pendingIntent) {
     ...
     */
    private class MetadataEditorCompat {
         ...
         */
        final static int METADATA_KEY_ARTWORK = 100;
    ...
    final Object getActualRemoteControlClientObject() {
